...
<nav class="navbar custom-navbar navbar-expand-lg py-2"style="background-color:black;">
    <div class="container-fluid px-0">
        
        <a href="dashboard.php" class="navbar-brand"><strong>VBAS</strong></a>
        <div id="navbar_main" style="background-color:black;" >
